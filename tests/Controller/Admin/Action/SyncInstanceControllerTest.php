...
#[CoversClass(SyncInstanceController::class)]
final class SyncInstanceControllerTest extends AbstractWebTestCase
{
    public function testUnauthenticatedAccessIsBlocked(): void
    {
        $client = self::createClient();
        $client->request('POST', '/admin/instance/1/sync');
    ...
    {
        $client = self::createClient();
        $client->request('GET', '/admin/instance/1/sync');
    ...
    {
        $client = self::createClient();
        $client->request('OPTIONS', '/admin/instance/1/sync');
    ...
    {
        $client = self::createClient();
        $client->request('PUT', '/admin/instance/1/sync');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('DELETE', '/admin/instance/1/sync');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('PATCH', '/admin/instance/1/sync');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('HEAD', '/admin/instance/1/sync');
    ...
    {
        $client = self::createClient();
        $client->request($method, '/admin/instance/1/sync');

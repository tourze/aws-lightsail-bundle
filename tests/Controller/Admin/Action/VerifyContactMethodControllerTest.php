...
#[CoversClass(VerifyContactMethodController::class)]
final class VerifyContactMethodControllerTest extends AbstractWebTestCase
{
    public function testUnauthenticatedAccessIsBlocked(): void
    {
        $client = self::createClient();
        $client->request('POST', '/admin/contact-method/1/verify');
    ...
    {
        $client = self::createClient();
        $client->request('GET', '/admin/contact-method/1/verify');
    ...
    {
        $client = self::createClient();
        $client->request('OPTIONS', '/admin/contact-method/1/verify');
    ...
    {
        $client = self::createClient();
        $client->request('PUT', '/admin/contact-method/1/verify');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('DELETE', '/admin/contact-method/1/verify');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('PATCH', '/admin/contact-method/1/verify');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('HEAD', '/admin/contact-method/1/verify');
    ...
    {
        $client = self::createClient();
        $client->request($method, '/admin/contact-method/1/verify');

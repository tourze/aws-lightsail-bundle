...
#[CoversClass(ExportCertificateController::class)]
final class ExportCertificateControllerTest extends AbstractWebTestCase
{
    public function testUnauthenticatedAccessIsBlocked(): void
    {
        $client = self::createClient();
        $client->request('POST', '/admin/certificate/1/export');
    ...
    {
        $client = self::createClient();
        $client->request('GET', '/admin/certificate/1/export');
    ...
    {
        $client = self::createClient();
        $client->request('OPTIONS', '/admin/certificate/1/export');
    ...
    {
        $client = self::createClient();
        $client->request('PUT', '/admin/certificate/1/export');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('DELETE', '/admin/certificate/1/export');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('PATCH', '/admin/certificate/1/export');
        $this->assertContains($client->getResponse()->getStatusCode(), [404, 405]);
    }
    ...
    {
        $client = self::createClient();
        $client->request('HEAD', '/admin/certificate/1/export');
    ...
    {
        $client = self::createClient();
        $client->request($method, '/admin/certificate/1/export');

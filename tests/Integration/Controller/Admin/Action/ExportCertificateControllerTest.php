...
final class ExportCertificateControllerTest extends TestCase
{
    private ExportCertificateController $controller;

    protected function setUp(): void
    {
        $adminUrlGenerator = $this->createMock(AdminUrlGenerator::class);
        $this->controller = new ExportCertificateController($adminUrlGenerator);
    }

    public function testController_isInitializedCorrectly(): void
    {
        $this->assertInstanceOf(ExportCertificateController::class, $this->controller);
    }
}

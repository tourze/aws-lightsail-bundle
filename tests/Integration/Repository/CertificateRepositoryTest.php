...
final class CertificateRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->managerRegistry->method('getManagerForClass')
            ->with(Certificate::class)
            ->willReturn($this->entityManager);
            
        $this->repository = new CertificateRepository($this->managerRegistry);
    }

    public function testGetEntityClass_returnsCorrectClass(): void
    {
        $this->assertSame(Certificate::class, $this->repository->getClassName());
    }
    ...
    {
        $this->assertInstanceOf(CertificateRepository::class, $this->repository);
    }
}

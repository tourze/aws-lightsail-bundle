...
final class RestartContainerServiceController extends AbstractController
{
    ...
    #[Route(path: '/admin/container-service/{entityId}/restart', name: 'restart_container_service', methods: ['POST'])]

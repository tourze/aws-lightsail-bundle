...
final class CreateDatabaseSnapshotController extends AbstractController
{
    ...
    #[Route(path: '/admin/database/{entityId}/create-snapshot', name: 'create_database_snapshot', methods: ['POST'])]

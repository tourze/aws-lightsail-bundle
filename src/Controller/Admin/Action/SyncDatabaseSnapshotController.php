...
final class SyncDatabaseSnapshotController extends AbstractController
{
    ...
    #[Route(path: '/admin/database-snapshot/{entityId}/sync', name: 'sync_database_snapshot', methods: ['POST'])]

...
final class ExportDatabaseSnapshotController extends AbstractController
{
    ...
    #[Route(path: '/admin/database-snapshot/{entityId}/export', name: 'export_database_snapshot', methods: ['POST'])]

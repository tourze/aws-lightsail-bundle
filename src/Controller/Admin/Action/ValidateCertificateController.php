...
final class ValidateCertificateController extends AbstractController
{
    ...
    #[Route(path: '/admin/certificate/{entityId}/validate', name: 'validate_certificate', methods: ['POST'])]

...
final class DeployContainerServiceController extends AbstractController
{
    ...
    #[Route(path: '/admin/container-service/{entityId}/deploy', name: 'deploy_container_service', methods: ['POST'])]

 ...
 *
 * @extends AbstractCrudController<Distribution>
 */
#[AdminCrud(
    routePath: '/aws-lightsail/distribution',
    routeName: 'aws_lightsail_distribution'
)]
final class DistributionCrudController extends AbstractCrudController
{

 ...
 * Lightsail 磁盘管理控制器
 *
 * @extends AbstractCrudController<Disk>
 */
#[AdminCrud(
    routePath: '/aws-lightsail/disk',
    routeName: 'aws_lightsail_disk'
)]
final class DiskCrudController extends AbstractCrudController
{

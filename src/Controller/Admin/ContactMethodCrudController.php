 ...
 * Lightsail 联系方式管理控制器
 *
 * @extends AbstractCrudController<ContactMethod>
 */
#[AdminCrud(
    routePath: '/aws-lightsail/contact-method',
    routeName: 'aws_lightsail_contact_method'
)]
final class ContactMethodCrudController extends AbstractCrudController
{
